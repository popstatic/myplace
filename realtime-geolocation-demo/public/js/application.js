$(function() {
	...
	if (navigator.geolocation) {
		...
		$('.map').text('Votre navigateur ne supporte pas la geolocalisation');
	}
	...
	function positionSuccess(position) {
		...
		userMarker.bindPopup('<p>Vous etes ici ! votre identifiant unique : ' + userId + '</p>').openPopup();
	...
	function setMarker(data) {
		for (var i = 0; i < data.coords.length; i++) {
			...
			marker.bindPopup('<p>Un autre utilisateur est ici !</p>');
